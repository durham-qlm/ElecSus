...
FitType = 'SA'        # Choices: 'T' for just theory (later fitting options ignored)
...
DataFilename = 'SampleDataRbD2' #For theory plots this is only used as a label for the data.

#### Essential cell parameters ####
###################################

#Temperature 
NdenTemp = 65.0       #in degrees Celsius.
...
Theta0Bool = True     #Choose to fit? (True or False) (NOT true or false)
...
Gamma = 50.0          #Lorentzian width due to buffer gas, in MHz
...
DoppTemp = 25.0       #in deg C. Overided by the number density temp if constrained
