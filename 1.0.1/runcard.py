...
DoppTemp = 50.0        #in deg C. Overided by the number density temp if constrained
...
DetStart = -8.0       #Detuning start value in GHz
DetStop  = 8.0        #Detuning end value in GHz
...
PlotHypBool = True #(True or False)