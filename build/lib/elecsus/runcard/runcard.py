...
element = 'Cs'        # 'K' for potassium, 'Na' for sodium
...
FitType = 'T'         # Choices: 'T' for just theory (later fitting options ignored)
...
DataFilename = 'TEST' #For theory plots this is only used as a label for the data.

#### Essential cell parameters ####
###################################

#Temperature 
NdenTemp = 25.0       #in degrees Celsius.
NdenTempBool = True   #Choose to fit? (True or False) (NOT true or false)

#This is the path length of the atomic medium.
CellLength = 75.0     #in millimetres
...
#Magnetic field
Bfield = 0.0          #in Gauss
BfieldBool = False     #Choose to fit? (True or False) (NOT true or false)

#Initial polarization angle (see equation 20 in manual)
Theta0 = 0.0          #in degrees. Only important for S1, S2, Ix, Iy spectrum types
...
Gamma = 0.0            #Lorentzian width due to buffer gas, in MHz
GammaBool = False      #Choose whether to fit or not (True or False)

#Doppler temperature
ConstrainBool = True   #Constain the doppler temp to the number density temp?
DoppTemp = 20.0        #in deg C. Overided by the number density temp if constrained
...
Rb85 = 72.17            #in %. 72.17 is the natural abundance
...
K40 = 0.0117  
#Not possible to fit these in this version.
...
DetStart = -15.0 #Detuning start value in GHz
DetStop  = 15.0  #Detuning end value in GHz
